...
install-plugin: install ## Install plugin and test with LLM
	...
	@echo "llm tools  # Should show Patch tools"
	@echo "llm prompt 'Read this file' --tool Patch_patch_read /path/to/file.txt"
...
watch-test: ## Watch for changes and run tests
	...
	source .venv/bin/activate && ptw tests/ llm_tools_patch.py
